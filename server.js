...
mongoose.connect(process.env.MONGODB_URI || "mongodb+srv://admin:utbqTdERwXRCWvZK@mern-website.d6sigzw.mongodb.net/", {
    useNewUrlParser: true,
    useUnifiedTopology: true
}, () => {
    console.log("Connect to toster database")
})
...
app.listen(PORT, () => {
    console.log(`server running on @mern-website.d6sigzw.mongodb.net/toster`);
  });
